...
# OSM data pipeline
check_overpass_availability >> fetch_osm_raw >> transform_to_geojson >> insert_geojson_to_mongodb >> process_distances_task >> end

# SRTM data pipeline and distance calculation
[download_srtm >> unzip_srtm >> move_tif, insert_geojson_to_mongodb] >> process_elevations_task >> calculate_elevation_profile_task >> end
